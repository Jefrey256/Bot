...
const ceemde = JSON.parse(fs.readFileSync('./K-DATABASE/data/totalcmd.json'));
...
function upload(midia) {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      form.append('fileToUpload', midia, { filename: `tmp.${ext}` });
...
fs.writeFileSync('./K-PLUGINS/sticker/data.exif', Buffer.concat([_, __, ___, ____]), function (err) {
console.log(err)
if (err) return console.error(err)
return `./K-PLUGINS/sticker/data.exif`
})
}
...
const banner2 = cfonts.render((`New Edition \n Dev: Matheus \n +55 38 9116-4328`), {
font: 'console',
align: 'center',
gradient: ['white', 'white']
});
 
const banner3 = cfonts.render((`KIMORI`), {
  font: 'block',
  align: "center",
  gradient: ['white', 'white']
});
...
const authorname = "Kimori System"
const packname = "Criador: @Matheus"

const chyt = "553891164328@s.whatsapp.net";
const nit = "553891164328@s.whatsapp.net";
const supre = "553891164328@s.whatsapp.net";
